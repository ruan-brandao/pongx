defmodule PongxWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use PongxWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import PongxWeb.ConnCase
    end
  end

  setup tags do
    Pongx.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_player(%{conn: conn}) do
    player = Pongx.PlayersFixtures.player_fixture()
  ...
  def log_in_player(conn, player) do
    token = Pongx.Players.generate_player_session_token(player)

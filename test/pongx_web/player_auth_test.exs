defmodule PongxWeb.PlayerAuthTest do
  use PongxWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Pongx.Players
  alias PongxWeb.PlayerAuth
  import Pongx.PlayersFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PongxWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_player/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PongxWeb.Endpoint.subscribe(live_socket_id)

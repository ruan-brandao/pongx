defmodule PongxWeb.PlayerAuth do
  use PongxWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_pongx_web_player_remember_me"
  ...
  def log_out_player(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      PongxWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_player:
      ...
      defmodule PongxWeb.PageLive do
        use PongxWeb, :live_view

        on_mount {PongxWeb.PlayerAuth, :mount_current_player}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{PongxWeb.PlayerAuth, :ensure_authenticated}] do

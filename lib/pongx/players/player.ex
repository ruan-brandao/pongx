defmodule Pongx.Players.Player do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Pongx.Repo)
  ...
  """
  def valid_password?(%Pongx.Players.Player{hashed_password: hashed_password}, password)
